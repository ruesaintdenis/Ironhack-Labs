...
select rank_description.fac_rank_M, rank_description.fac_rank_C, 
from rank_description
join faculty 
on faculty.fac_Rank_C = rank_description.fac_rank_C;


select rank_description.fac_rank_M, rank_description.fac_rank_C, faculty.fac_First_M
from rank_description
where fac_rank_C in 
(select fac_Rank_C
from faculty);
...
from faculty 
where faculry.fac_Rank_C
(select fac_rank_C, Fac_Rank_M 
from rank_description);


select * from rank_description;
WHERE rank_description.fac_rank_c = faculty.fac_rank_c